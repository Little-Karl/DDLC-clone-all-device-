...
define config.save_directory = "DDLC-1620117020"
...
# this will be changed to ask the player for name once the story is 90s% finished
...
##########
# bg
image bg residential = "residential.png"
